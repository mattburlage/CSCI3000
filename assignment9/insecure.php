        ...
        <div class="row mb-5 mt-3">
            <div class="col">
                ...
                <div>
                    ...
                    Back to <a href="index.php">home.</a> Or try on the <a href="secure.php">secure page.</a>
                </div>
            </div>
        </div>
        <div class="row">
            ...
            <div class="col-12">
                ...
                if ($_SERVER['REQUEST_METHOD'] === 'POST') {
                    ...
                    if ($all_valid) {
                        ...
                        $query = $db->prepare("INSERT INTO registration (first_name, last_name, residence_status,
						class_status, email)
						VALUES  ('".$values['first_name']."','".$values['last_name']."', '".$values['resident']."',
						 '".$values['class_status']."', '".$values['email']."')");
