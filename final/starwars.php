...
$queryins = $db->prepare("UPDATE pagecount set count = count + 1 WHERE page = 'starwars'");
$queryins->execute();

$query = $db->prepare("SELECT * FROM starwars ORDER BY id DESC LIMIT 100");
...
<head>
    ...
    <link rel="stylesheet" href="css/starwarsfont.css"/>
...
<div class="container body-container no-star-wars">
    ...
    <div class="collapse stories-toggle">
        <div class="row mt-3">
            <div class="col">
                <table class="table">
                    <thead>
                    ...
                    foreach ($results as $row) {
                        echo "<tr>
                            <td><a href='#' onclick='pickStory(".$row['id']."); return false;'> ".$row['id']."</a></td>
                            <td><a href='#' onclick='pickStory(".$row['id']."); return false;'> ".$row['title']."</a></td>
                        </tr>
                    ";
                    }
                    ?>
...
<!--<div id="hide-star-wars" hidden>-->
    <section class="sw-trigger" id="intro">
        A long time ago, in a galaxy far,<br> far away....
    </section>

    <section class="sw-trigger" id="logo">
...
<!--</svg>-->
<br><br>
        <div class="display-4 star-wars-logo">csci 3000</div>
    </section>
    ...
    <div id="board" class="sw-trigger vanish-at-end">
        <div id="content">
            ...
            <p>
                It is a
                <span id="word1_tar">period</span>
                of civil war.
                Rebel
                <span id="word2_tar">spaceships</span>,
                striking
                from a hidden
                <span id="word3_tar">base</span>,
                have won
...
<!--            <button class="btn btn-lg btn-outline-primary large-btn btn-block">Done!</button>-->
        </div>
    </div>
<!--</div>-->


<div class="container mt-5 mb-5 no-star-wars">
    <div class="row">
...
<div class="container fade5000" id="end-thanks" style="display: none">
    <div class="row">
...
<audio preload="auto" id="sw-audio">
    <source src="files/star-wars2.mp3" type="audio/mpeg">
</audio>
...
<script>
    const jsonRes = <? echo json_encode($results) ?>
</script>
</body>
</html>